...
public class HeroInventory implements Inventory {
    ...
    private void combineRecipe(Recipe recipe) {
        ...
        String newItemName = recipe.getName();
        ...
        Item newItem = ItemFactory.createCommonItem(newItemName, strengthBonus, agilityBonus, intelligenceBonus, hitPointsBonus, damageBonus);
