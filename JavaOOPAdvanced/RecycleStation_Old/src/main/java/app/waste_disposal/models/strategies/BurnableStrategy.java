...
public class BurnableStrategy extends BaseGarbageDisposalStrategy {

    private static final double ENERGY_USED_DEFAULT = 0.2;
    private static final double ENERGY_PRODUCED_DEFAULT = 1;
