...
public class ShowWantedCourseCommand extends Command {
    public ShowWantedCourseCommand(String input, String[] data, StudentsRepository repository, Tester tester, IOManager ioManager, DownloadManager downloadManager) {
