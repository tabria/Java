...
public class EvaluateExpression {
    ...
    public static void main(String[] args) {
        ...
        Deque<Double> stackD = new ArrayDeque<>();
        ...
        while(!queue.isEmpty()){
            ...
            if (currentElement.equals("^")) {
                double first = stackD.pop();
                stackD.push(Math.pow(stackD.pop(), first));
            } else if (currentElement.equals("*") ) {
                double first = stackD.pop();
                stackD.push(stackD.pop() * first);
            } else if (currentElement.equals("/")) {
                double first = stackD.pop();
                stackD.push(stackD.pop() / first);
            } else if (currentElement.equals("+")) {
                ...
                stackD.push(Double.parseDouble(currentElement));
            }
        }
        System.out.printf("%.2f",stackD.pop());
    }
