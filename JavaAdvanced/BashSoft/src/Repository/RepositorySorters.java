...
public class RepositorySorters {
    ...
    public static void printSortedStudents(HashMap<String, ArrayList<Integer>> courseData, String comparisionType, int numberOfStudents) {
        ...
        if (comparisionType.equals("descending")){
