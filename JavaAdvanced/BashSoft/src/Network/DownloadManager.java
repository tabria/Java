...
public class DownloadManager {
    ...
    public static void downloadOnNewThread(String fileUrl) throws InterruptedException {
        ...
        thread.start();
        thread.join();
        OutputWriter.writeMessageOnNewLine(String.format("Worker thread %d complete download..", thread.getId()));
    }
}
