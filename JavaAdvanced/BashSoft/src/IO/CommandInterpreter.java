...
public class CommandInterpreter {
    ...
    public static void interpretCommand(String input) throws IOException, InterruptedException {
    ...
    private static void tryDownloadFileOnNewThread(String input, String[] data) throws InterruptedException {
        if (data.length !=2) {
            displayInvalidCommandMessage(input);
            return;
        }
